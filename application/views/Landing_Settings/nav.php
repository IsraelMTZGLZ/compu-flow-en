...
<body id="<?=($title) ?>" class="homepage-v1 lang-en country-us currency-eur layout-full-width <?=($class) ?>  tax-display-disabled  patternnone keepmenutop">
	<main>
		<header id="header">
									...
									<div id="splanguage" class="language_currency clearfix">
										<div class="lc-selector-wrapper">
											<div class="lc-selector dropdown js-dropdown">
												...
												<ul class="sp-dropdown-menu">
													<li class="current">
														<a href="http://localhost/compuflow/Inicio" class="language-item"  >
															English
														</a>
													</li>
													<li>
														<a href="https://www.compuflowmx.com/" class="language-item" target="_blank">
															Español
														</a>
													</li>
												</ul>
									...
									<nav class="navbar-default navbar-vertical" role="navigation">
										<div class="navbar-header">
											<button type="button" id="show-vermegamenu" data-toggle="collapse" data-target=".sp-vermegamenu" class="navbar-toggle">
												<span class="vertical_title">Products</span>
											</button>
										</div>
