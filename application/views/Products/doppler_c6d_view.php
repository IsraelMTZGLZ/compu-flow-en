            ...
            <section id="main" class="product-page" itemscope itemtype="https://schema.org/Product">
                ...
                <div class="row">
                        ...
                        <section class="page-content" id="content">
                            ...
                            <div class="images-container">
                                ...
                                <div class="product-cover">
                                    ...
                                    src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_a152231b77a44d97b2e3acaa65861fc9.webp'); ?>" alt="" title="" style="width:100%;" itemprop="image">
                                ...
                                <div class="js-qv-mask mask">
                                    <ul class="product-images js-qv-product-images">
                                        <li class="thumb-container">
                                            ...
                                            data-image-medium-src="<?= base_url('resources/landingpage/img/products/C6D/medium/22b01a_a152231b77a44d97b2e3acaa65861fc9.png'); ?>" 
                                            data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_a152231b77a44d97b2e3acaa65861fc9.webp'); ?>" 
                                            src="<?= base_url('resources/landingpage/img/products/C6D/small/22b01a_a152231b77a44d97b2e3acaa65861fc9.png'); ?>" alt="" title="" width="110" itemprop="image">
                                        </li>
                                        <li class="thumb-container">
                                            <img class="thumb js-thumb " 
                                            data-image-medium-src="<?= base_url('resources/landingpage/img/products/C6D/medium/22b01a_04176076c7cf4462a247a155e264639c.png'); ?>"
                                             data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_04176076c7cf4462a247a155e264639c.webp'); ?>"
                                              src="<?= base_url('resources/landingpage/img/products/C6D/small/22b01a_04176076c7cf4462a247a155e264639c.png'); ?>" alt="" title="" width="110" itemprop="image">
                                        </li>
                                        <li class="thumb-container">
                                            <img class="thumb js-thumb " 
                                            data-image-medium-src="<?= base_url('resources/landingpage/img/products/C6D/medium/22b01a_ee7e392fdfd24ca89c7e96555339f880.png'); ?>" 
                                            data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_ee7e392fdfd24ca89c7e96555339f880.webp'); ?>" 
                                            src="<?= base_url('resources/landingpage/img/products/C6D/small/22b01a_ee7e392fdfd24ca89c7e96555339f880.png'); ?>" alt="" title="" width="110" itemprop="image">
                                        </li>
                                        <li class="thumb-container">
                                            <img class="thumb js-thumb " 
                                            data-image-medium-src="<?= base_url('resources/landingpage/img/products/C6D/medium/22b01a_7999c0db174a45e08687640113e8949e.png'); ?>" 
                                            data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_7999c0db174a45e08687640113e8949e.webp'); ?>" 
                                            src="<?= base_url('resources/landingpage/img/products/C6D/small/22b01a_7999c0db174a45e08687640113e8949e.png'); ?>" alt="" title="" width="110" itemprop="image">
                                        </li>
                    ...
                    <div class="sp_product_content pp_rightcolumn col-xs-12 col-sm-12 col-md-12 col-lg-5 clearfix">
                        ...
                        <h1 class="h1 product-name" itemprop="name">COMPU-FLOW™ C6D FIXED DOPPLER METER</h1>
                        ...
                        <div class="product-information">
                            ...
                            <div id="product-description-short-50" class="product-short-description" itemprop="description">
                                <p><span style="font-family:'Open Sans', Arial, sans-serif;font-size:14px;text-align:justify;">The Compu-Flow™ Ultrasonic Doppler Flowmeter is a highly accurate and easy-to-use stationary metering system for the measurement of fluids with high solids content through pipes from ½ to 999 inches inside diameter ( .013 to 25 meters).</span></p>
                            </div>
                            <!-- <div>
                                <ul class="criterions_list">
                                    ...
                                    <li>
                                    - Compu-Flow™ Smart-Flow Technology
                                    </li>
                                    <li>
                                    - Compact and lightweight
                                    </li>
                                    <li>
                                    - A clean solution for multi-industry flow measurement
                                    </li>
                                    <li>
                                ...
                                <div class="modal-body">
                                    <figure>
                                        <img class="js-modal-product-cover product-cover-modal" width="800"
                                         src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_a152231b77a44d97b2e3acaa65861fc9.webp'); ?>" alt="" title="" itemprop="image">
                                        ...
                                        <div class="js-modal-mask mask  nomargin ">
                                            <ul class="product-images js-modal-product-images">
                                                <li class="thumb-container">
                                                    ...
                                                    src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_a152231b77a44d97b2e3acaa65861fc9.webp'); ?>" 
                                                    alt="" title="" width="300" itemprop="image">
                                                </li>
                                                <li class="thumb-container">
                                                    <img data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_04176076c7cf4462a247a155e264639c.webp'); ?>" class="thumb js-modal-thumb" src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_04176076c7cf4462a247a155e264639c.webp'); ?>" alt="" title="" width="300" itemprop="image">
                                                </li>
                                                <li class="thumb-container">
                                                    <img data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_ee7e392fdfd24ca89c7e96555339f880.webp'); ?>" class="thumb js-modal-thumb" src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_ee7e392fdfd24ca89c7e96555339f880.webp'); ?>" alt="" title="" width="300" itemprop="image">
                                                </li>
                                                <li class="thumb-container">
                                                    <img data-image-large-src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_7999c0db174a45e08687640113e8949e.webp'); ?>" class="thumb js-modal-thumb" src="<?= base_url('resources/landingpage/img/products/C6D/large/22b01a_7999c0db174a45e08687640113e8949e.webp'); ?>" alt="" title="" width="300" itemprop="image">
                                                </li>
                                            </ul>
                                        </div>
